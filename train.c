...
static int isRoute(const char *source,
                   ...
                   const char *b)
{
    ...
    (
        (strcmp(source,a) == 0 &&
         strcmp(destination,b) == 0)
 
        ||
 
        (strcmp(source,b) == 0 &&
         strcmp(destination,a) == 0)
    );
}
 
void showAvailableTrains(const char *source,
                         const char *destination)
{
    int found = 0;
...
void showAlternateRoutes(const char *source,
                         const char *destination)
{
    printf("\n=================================\n");
